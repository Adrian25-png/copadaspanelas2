-- Copa das Panelas - Banco de Dados Atualizado
-- Versão 2.0 com Sistema de Versionamento de Torneios
-- CORREÇÃO PARA ERRO DE TRANSAÇÃO
...
/*
CORREÇÕES APLICADAS PARA RESOLVER ERRO DE TRANSAÇÃO:

1. TournamentManager.php corrigido:
   - Backup isolado sem transação aninhada
   - Transação única para operações principais
...
3. Como aplicar:
   mysql -u root < bd_copa_atualizado.sql

4. Acesso:
   http://localhost/copadaspanelas2/app/pages/adm/tournament_list.php

STATUS: ERRO DE TRANSAÇÃO CORRIGIDO
*/
