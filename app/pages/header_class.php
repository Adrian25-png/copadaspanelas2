    ...
    <div class="header" id="header">
        ...
        <div class="navegacao_header" id="navegacao_header">
            ...
            <div class="has-submenu">
                <div id="ativo" >
                    <a href="../pages/rodadas.php">Rodadas</a>
                </div>
            ...
            <div class="has-submenu">
                <div id="ativo" >
                    <a href="../pages/tabela_de_classificacao.php">Classificação</a>
                </div>
                <?php if ($usuarioLogado): ?>
                <div class="submenu">
                    <a href="../pages/classificar.php">Classificados</a>
                </div>
                <?php endif; ?>
            </div>
            <div class="has-submenu">
                <div id="ativo" >
                    <a href="../pages/exibir_finais.php">Finais</a>
                </div>
                <?php if ($usuarioLogado): ?>
                <div class="submenu">
            ...
            <div class="has-submenu">
                <div id="ativo" >
                     <a href="../pages/estatistica.php">Estatísticas</a>
                </div>
                <?php if ($usuarioLogado): ?>
                <div class="submenu">
